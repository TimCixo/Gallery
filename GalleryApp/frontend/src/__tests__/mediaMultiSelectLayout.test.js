...
test("multi-select styles highlight selected media and bulk actions", () => {
  ...
  assert.match(appCss, /\.media-quick-tagging-modal\s*\{[\s\S]*overflow:\s*visible/);
  ...
  assert.match(appCss, /\.media-modal-body\.media-quick-tagging-body\s*\{[\s\S]*position:\s*relative/);
  assert.match(appCss, /\.media-modal-body\.media-quick-tagging-body\s*\{[\s\S]*z-index:\s*1/);
  assert.match(appCss, /\.media-modal-body\.media-quick-tagging-body\s*\{[\s\S]*overflow:\s*visible/);
  assert.match(appCss, /\.media-modal-body\.media-quick-tagging-body\s*\{[\s\S]*padding:\s*0 1rem 0\.9rem/);
  ...
  assert.match(appCss, /\.media-quick-tagging-input-wrap:focus-within\s*\{[\s\S]*z-index:\s*3/);
  assert.match(appCss, /\.media-quick-tagging-input-wrap:focus-within \.media-quick-tagging-input-highlight/);
  assert.match(appCss, /\.media-tag-dropdown\s*\{[\s\S]*z-index:\s*40/);
