...
- **Превʼю відео/GIF:** `ffmpeg` (автоматичний пошук у `run-app.py`).
...
│     └─ src/App.css
├─ run-app.py                   # Універсальний скрипт запуску backend + frontend
├─ run-app.ps1                  # Windows wrapper для сумісності
└─ README.md
```
